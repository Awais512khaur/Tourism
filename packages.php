...
<section class="page-section bg-light" id="home">
	<div>
<button type="button" name="custom_btn" style="margin-left: 80%;" class="btn btn-secondary"><a href="cus.php" style="text-decoration: none;">Customizable Packages</a></button>
	...
	<div class="d-flex w-100 justify-content-center">
		...
		?>
			...
			<div class="card d-flex w-100 rounded-0 mb-3 package-item" id="g">
				<img class="card-img-top" src="<?php echo validate_image($cover) ?>" alt="<?php echo $row['title'] ?>" height="212rem" style="object-fit:cover">
				<div class="card-body">
				...
				<div class="w-100 d-flex justify-content-between">
					<span class="rounded-3 btn bg-gray btn-primary btn-flat btn-sm"><i class="fa fa-tag"></i> <?php echo number_format($row['cost']) ?></span>
