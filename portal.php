...
<header class="masthead">
	<div class="container page-section">
		<div class="masthead-subheading">Welcome To Tour Hub</div>
...
<section class="page-section" id="contact">
	<div class="container">
		...
		<form id="contactForm" >
			...
			<div class="text-center"><button class="btn btn-primary btn-xl text-uppercase" id="submitButton" type="submit" style="background-color: gradient();">Send Message</button></div>
		</form>
	</div>
</section>
<script>
